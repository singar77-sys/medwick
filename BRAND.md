...
| Navy (ink) | `#1A1F29` | 26, 31, 41 | Deepest — text on gold buttons, max contrast. |
...
- `#C0A674` gold on white is **~1.9:1** — fails for text. Use gold only for fills, rules, and large display; use `#7D6634` (gold-ink, ~5:1) or navy for actual small text on white.
...
| Body copy (site only, not from logo) | — | Source Sans 3 (400/600/700) |
...
- Logo file: `public/medwick-logo.webp` (400×400, navy field baked in — sits best on a navy or neutral tile, not on white).
