...
Phased build plan with **SEO gates** — each phase has a pass/fail check before the next starts. Aligned to the audit's 90-day plan (§6) and extended to 12 months. Window opens July 13, 2026 inside peak storm season.
...
1. **Fix the hero CTA phone number (C1)** — button dials an Akron cell, not the displayed line. Confirm what 620-8778 is with the owner, then point `tel:` at (330) 635-3744. One-line fix, immediate lead recovery.
