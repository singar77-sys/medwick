// Registry for the internal /proposal section: the Digital Growth Plan
// (strategy docs + competitive authority reports) that closed this deal.
// Kept for reference, not linked from primary nav, noindexed regardless of
// the site-wide production gate. Ported from site/app/lib/docs.js.
...
export const DOCS = [
  {
    ...
    blurb:
      'Positioning, the flanking bet, 3/6/12-month targets, and the technical foundation the new site must ship with.',
  },
  {
    slug: 'site-structure',
  ...
  },
  {
    ...
    blurb:
      'The three market scans distilled: the top threats in roofing, water, and remodeling, each rival’s exploitable gap, and how Medwick wins each one.',
  },
  {
    ...
    blurb:
      'The 80%: the off-site authority the website only displays. Reviews, storm publishing, documentation, GBP, insurance relationships, sponsorships, and awards.',
  },
];

// Self-contained HTML dashboards served statically from /public/reports.
...
// Everything renderable via the /proposal/[slug] route: the position plus the docs.
